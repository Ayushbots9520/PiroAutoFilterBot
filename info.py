...
REQ_PICS = (environ.get('REQ_PICS', 'https://graph.org/file/c0b9ce8ba3253a806409f.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/c0b9ce8ba3253a806409f.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-100215815492').split()]
